...
export default function Home() {
  ...
  const handleUploadComplete = (data: { base64: string; name: string }) => {
    console.log('Upload complete:', data);
    const newId = Date.now().toString();
    // TODO: Integrate with puter.action.ts or storage
    navigate(`/visualizer/${newId}`, { state: data });
  };
  ...
  <div className="home">
    ...
    <section className="hero">
      ...
      <p className="subtitle">Roomify is an AI-based design environment that helps you visualize, render and ship home designs faster than ever.</p>
